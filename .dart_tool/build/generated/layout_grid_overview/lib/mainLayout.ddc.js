define(['dart_sdk', 'packages/flutter_web/animation', 'packages/layout_grid_overview/LayoutGrid/src/layout_grid', 'packages/layout_grid_overview/LayoutGrid/src/Util/inherited_layout_model', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_private_units', 'packages/layout_grid_overview/LayoutGrid/src/layout_grid_couple', 'packages/flutter_web/material', 'packages/flutter_web/src/animation/animation', 'packages/flutter_web_ui/ui'], function(dart_sdk, animation, layout_grid, inherited_layout_model, layout_grid_units, layout_grid_private_units, layout_grid_couple, material, animation$, ui) {
  ...
  mainLayout.LeftGrid = class LeftGrid extends src__widgets__framework.StatelessWidget {
    ...
    build(context) {
      ...
      return new src__widgets__container.Container.new({child: new LayoutGrid__src__layout_grid.LayoutGrid.new({maxWidth: this.model.getWidth(this.modelKey), maxHeight: this.model.getHeight(this.modelKey), layoutModel: LayoutGrid__src__Util__inherited_layout_model.InheritedLayoutModel.of(context), columns: JSArrayOfLayoutUnit().of([new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 0.0, priority: 1}), new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: this.model.getWidth(this.modelKey), priority: 1})]), rows: JSArrayOfLayoutUnit().of([new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 0.0}), new LayoutGrid__src__Util__layout_grid_units.LayoutDependent.new({line: 1, multiplicator: 1.0}), new LayoutGrid__src__Util__layout_grid_units.LayoutDependent.new({line: 1, multiplicator: 0.625}), new LayoutGrid__src__Util__layout_grid_units.LayoutDependent.new({line: 1, multiplicator: 0.625}), new LayoutGrid__src__Util__layout_grid_units.LayoutDependent.new({line: 1, multiplicator: 0.625})]), couples: JSArrayOfLayoutGridCouple().of([new LayoutGrid__src__layout_grid_couple.LayoutGridCouple.new({widget: new mainLayout.Section.new({text: "1", color: src__material__colors.Colors.blueGrey, modelKey: "1", $creationLocationd_0dea112b090073317d4: const$35 || (const$35 = dart.const(new src__widgets__widget_inspector._Location.new({line: 119, column: 21, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$34 || (const$34 = dart.constList([const$31 || (const$31 = dart.const(new src__widgets__widget_inspector._Location.new({line: 119, column: 29, name: "text"}))), const$32 || (const$32 = dart.const(new src__widgets__widget_inspector._Location.new({line: 119, column: 40, name: "color"}))), const$33 || (const$33 = dart.const(new src__widgets__widget_inspector._Location.new({line: 119, column: 64, name: "modelKey"})))], src__widgets__widget_inspector._Location))})))}), col0: 0, col1: 1, row0: 0, row1: 1, modelKey: "1"}), new LayoutGrid__src__layout_grid_couple.LayoutGridCouple.new({widget: new mainLayout.Section.new({text: "2", color: src__material__colors.Colors.blueGrey, modelKey: "2", $creationLocationd_0dea112b090073317d4: const$40 || (const$40 = dart.const(new src__widgets__widget_inspector._Location.new({line: 125, column: 21, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$39 || (const$39 = dart.constList([const$36 || (const$36 = dart.const(new src__widgets__widget_inspector._Location.new({line: 125, column: 29, name: "text"}))), const$37 || (const$37 = dart.const(new src__widgets__widget_inspector._Location.new({line: 125, column: 40, name: "color"}))), const$38 || (const$38 = dart.const(new src__widgets__widget_inspector._Location.new({line: 125, column: 64, name: "modelKey"})))], src__widgets__widget_inspector._Location))})))}), col0: 0, col1: 1, row0: 1, row1: 2, modelKey: "2"}), new LayoutGrid__src__layout_grid_couple.LayoutGridCouple.new({widget: new mainLayout.Section.new({text: "3", color: src__material__colors.Colors.blueGrey, modelKey: "3", $creationLocationd_0dea112b090073317d4: const$45 || (const$45 = dart.const(new src__widgets__widget_inspector._Location.new({line: 131, column: 21, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$44 || (const$44 = dart.constList([const$41 || (const$41 = dart.const(new src__widgets__widget_inspector._Location.new({line: 131, column: 29, name: "text"}))), const$42 || (const$42 = dart.const(new src__widgets__widget_inspector._Location.new({line: 131, column: 40, name: "color"}))), const$43 || (const$43 = dart.const(new src__widgets__widget_inspector._Location.new({line: 131, column: 64, name: "modelKey"})))], src__widgets__widget_inspector._Location))})))}), col0: 0, col1: 1, row0: 2, row1: 3, modelKey: "3"}), new LayoutGrid__src__layout_grid_couple.LayoutGridCouple.new({widget: new mainLayout.Section.new({text: "4", color: src__material__colors.Colors.blueGrey, modelKey: "4", $creationLocationd_0dea112b090073317d4: const$50 || (const$50 = dart.const(new src__widgets__widget_inspector._Location.new({line: 137, column: 21, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$49 || (const$49 = dart.constList([const$46 || (const$46 = dart.const(new src__widgets__widget_inspector._Location.new({line: 137, column: 29, name: "text"}))), const$47 || (const$47 = dart.const(new src__widgets__widget_inspector._Location.new({line: 137, column: 40, name: "color"}))), const$48 || (const$48 = dart.const(new src__widgets__widget_inspector._Location.new({line: 137, column: 64, name: "modelKey"})))], src__widgets__widget_inspector._Location))})))}), col0: 0, col1: 1, row0: 3, row1: 4, modelKey: "4"})]), $creationLocationd_0dea112b090073317d4: const$58 || (const$58 = dart.const(new src__widgets__widget_inspector._Location.new({line: 98, column: 14, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$57 || (const$57 = dart.constList([const$51 || (const$51 = dart.const(new src__widgets__widget_inspector._Location.new({line: 99, column: 9, name: "maxWidth"}))), const$52 || (const$52 = dart.const(new src__widgets__widget_inspector._Location.new({line: 100, column: 9, name: "maxHeight"}))), const$53 || (const$53 = dart.const(new src__widgets__widget_inspector._Location.new({line: 102, column: 9, name: "layoutModel"}))), const$54 || (const$54 = dart.const(new src__widgets__widget_inspector._Location.new({line: 104, column: 9, name: "columns"}))), const$55 || (const$55 = dart.const(new src__widgets__widget_inspector._Location.new({line: 109, column: 9, name: "rows"}))), const$56 || (const$56 = dart.const(new src__widgets__widget_inspector._Location.new({line: 117, column: 9, name: "couples"})))], src__widgets__widget_inspector._Location))})))}), $creationLocationd_0dea112b090073317d4: const$61 || (const$61 = dart.const(new src__widgets__widget_inspector._Location.new({line: 96, column: 12, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$60 || (const$60 = dart.constList([const$59 || (const$59 = dart.const(new src__widgets__widget_inspector._Location.new({line: 98, column: 7, name: "child"})))], src__widgets__widget_inspector._Location))})))});
    }
  };
  ...
  mainLayout.Section = class Section extends src__widgets__framework.StatelessWidget {
    ...
    build(context) {
      this.model = LayoutGrid__src__Util__inherited_layout_model.InheritedLayoutModel.of(context);
      return new src__widgets__container.Container.new({color: this.color, width: this.model.getWidth(this.modelKey), height: this.model.getHeight(this.modelKey), alignment: new src__painting__alignment.Alignment.new(0.0, 0.0), child: new src__widgets__text.Text.new(this.text, {style: new src__painting__text_style.TextStyle.new({color: src__material__colors.Colors.white, fontSize: 64.0}), $creationLocationd_0dea112b090073317d4: const$65 || (const$65 = dart.const(new src__widgets__widget_inspector._Location.new({line: 170, column: 14, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$64 || (const$64 = dart.constList([const$62 || (const$62 = dart.const(new src__widgets__widget_inspector._Location.new({line: 171, column: 9, name: "data"}))), const$63 || (const$63 = dart.const(new src__widgets__widget_inspector._Location.new({line: 172, column: 9, name: "style"})))], src__widgets__widget_inspector._Location))})))}), $creationLocationd_0dea112b090073317d4: const$72 || (const$72 = dart.const(new src__widgets__widget_inspector._Location.new({line: 161, column: 12, file: "org-dartlang-app:///packages/layout_grid_overview/mainLayout.dart", parameterLocations: const$71 || (const$71 = dart.constList([const$66 || (const$66 = dart.const(new src__widgets__widget_inspector._Location.new({line: 163, column: 7, name: "color"}))), const$67 || (const$67 = dart.const(new src__widgets__widget_inspector._Location.new({line: 165, column: 7, name: "width"}))), const$68 || (const$68 = dart.const(new src__widgets__widget_inspector._Location.new({line: 166, column: 7, name: "height"}))), const$69 || (const$69 = dart.const(new src__widgets__widget_inspector._Location.new({line: 168, column: 7, name: "alignment"}))), const$70 || (const$70 = dart.const(new src__widgets__widget_inspector._Location.new({line: 170, column: 7, name: "child"})))], src__widgets__widget_inspector._Location))})))});
    }
  };
