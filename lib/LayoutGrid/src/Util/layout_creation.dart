...
class Layout {
  ...
  static double _manageFractionsAndGetFreeSpace(List<LayoutUnit> joinedList, int joinedListIndex, List<double> sizes,double space, double freeSpace) {
    ...
    List<LayoutMinMax> _layoutMinMaxList = _initLayoutMinMaxList(joinedList, joinedListIndex, sizes);
    ...
    for (int _i=0; _i < joinedList.length; _i++) {
      ...
      if (sizes[joinedList[_i].index] == -1.0 && joinedList[_i].priority == joinedList[joinedListIndex].priority && joinedList[_i].axis == joinedList[joinedListIndex].axis) {
  ...
  static List<LayoutMinMax> _initLayoutMinMaxList(List<LayoutUnit> joinedList, int joinedListIndex, List<double> sizes) {

    List<LayoutMinMax> _layoutMinMaxList = List<LayoutMinMax>();

    for (int _i=0; _i < joinedList.length; _i++) {

      if (joinedList[_i] is LayoutMinMax && sizes[joinedList[_i].index] == -1.0 && joinedList[_i].priority == joinedList[joinedListIndex].priority && joinedList[_i].axis == joinedList[joinedListIndex].axis) {
