define(['dart_sdk', 'packages/flutter_web/animation', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_private_units', 'packages/layout_grid_overview/LayoutGrid/src/layout_grid_couple', 'packages/layout_grid_overview/LayoutGrid/src/Util/inherited_layout_model', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_creation', 'packages/flutter_web_ui/ui', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_child'], function(dart_sdk, animation, layout_grid_private_units, layout_grid_couple, inherited_layout_model, layout_creation, ui, layout_grid_child) {
  ...
  (LayoutGrid__src__layout_grid.LayoutGrid.new = function(opts) {
    ...
    let referenceWidth = opts && 'referenceWidth' in opts ? opts.referenceWidth : null;
    let referenceHeight = opts && 'referenceHeight' in opts ? opts.referenceHeight : null;
  ...
  const maxWidth$ = Symbol("LayoutGrid.maxWidth");
  const maxHeight$ = Symbol("LayoutGrid.maxHeight");
  const referenceWidth$ = Symbol("LayoutGrid.referenceWidth");
  const referenceHeight$ = Symbol("LayoutGrid.referenceHeight");
  ...
  dart.setFieldSignature(LayoutGrid__src__layout_grid.LayoutGrid, () => ({
    ...
    referenceWidth: dart.fieldType(core.double),
    referenceHeight: dart.fieldType(core.double),
  ...
  LayoutGrid__src__layout_grid._LayoutGridState = class _LayoutGridState extends src__widgets__framework.State$(LayoutGrid__src__layout_grid.LayoutGrid) {
    initState() {
      super.initState();
      if (this.widget.maxWidth != null) {
        this.widget.referenceWidth = this.widget.maxWidth;
      }
      if (this.widget.maxHeight != null) {
        this.widget.referenceHeight = this.widget.maxHeight;
      }
    ...
    build(context) {
      this.widget[_calculatedLayout] = LayoutGrid__src__Util__layout_creation.Layout.createLayout(this.widget.columns, this.widget.rows, this.widget.referenceWidth != null ? this.widget.referenceWidth : 0.0, this.widget.referenceHeight != null ? this.widget.referenceHeight : 0.0);
      ...
      return new src__widgets__container.Container.new({height: this.widget.maxHeight != null ? this.widget.maxHeight : this.widget[_calculatedLayout][$last], width: this.widget.maxWidth != null ? this.widget.maxWidth : this.widget[_calculatedLayout][$_get](dart.notNull(this.widget.columns[$length]) - 1), child: new src__widgets__basic.Stack.new({fit: src__rendering__stack.StackFit.expand, children: ListOfWidget().generate(this[_couples][$length], dart.fn(index => {
            ...
            return new LayoutGrid__src__Util__layout_grid_child.LayoutGridChild.new({key: this[_couples][$_get](index).key != null ? this[_couples][$_get](index).key : new src__widgets__framework.UniqueKey.new(), top: this[_top], left: this[_left], height: this[_height], width: this[_width], widget: this[_couples][$_get](index).widget, alignment: this[_couples][$_get](index).alignment, $creationLocationd_0dea112b090073317d4: const$7 || (const$7 = dart.const(new src__widgets__widget_inspector._Location.new({line: 89, column: 18, file: "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/layout_grid.dart", parameterLocations: const$6 || (const$6 = dart.constList([const$ || (const$ = dart.const(new src__widgets__widget_inspector._Location.new({line: 90, column: 13, name: "key"}))), const$0 || (const$0 = dart.const(new src__widgets__widget_inspector._Location.new({line: 91, column: 13, name: "top"}))), const$1 || (const$1 = dart.const(new src__widgets__widget_inspector._Location.new({line: 92, column: 13, name: "left"}))), const$2 || (const$2 = dart.const(new src__widgets__widget_inspector._Location.new({line: 93, column: 13, name: "height"}))), const$3 || (const$3 = dart.const(new src__widgets__widget_inspector._Location.new({line: 94, column: 13, name: "width"}))), const$4 || (const$4 = dart.const(new src__widgets__widget_inspector._Location.new({line: 95, column: 13, name: "widget"}))), const$5 || (const$5 = dart.const(new src__widgets__widget_inspector._Location.new({line: 96, column: 13, name: "alignment"})))], src__widgets__widget_inspector._Location))})))});
          }, intToLayoutGridChild())), $creationLocationd_0dea112b090073317d4: const$11 || (const$11 = dart.const(new src__widgets__widget_inspector._Location.new({line: 79, column: 14, file: "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/layout_grid.dart", parameterLocations: const$10 || (const$10 = dart.constList([const$8 || (const$8 = dart.const(new src__widgets__widget_inspector._Location.new({line: 80, column: 9, name: "fit"}))), const$9 || (const$9 = dart.const(new src__widgets__widget_inspector._Location.new({line: 81, column: 9, name: "children"})))], src__widgets__widget_inspector._Location))})))}), $creationLocationd_0dea112b090073317d4: const$16 || (const$16 = dart.const(new src__widgets__widget_inspector._Location.new({line: 74, column: 12, file: "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/layout_grid.dart", parameterLocations: const$15 || (const$15 = dart.constList([const$12 || (const$12 = dart.const(new src__widgets__widget_inspector._Location.new({line: 76, column: 7, name: "height"}))), const$13 || (const$13 = dart.const(new src__widgets__widget_inspector._Location.new({line: 77, column: 7, name: "width"}))), const$14 || (const$14 = dart.const(new src__widgets__widget_inspector._Location.new({line: 79, column: 7, name: "child"})))], src__widgets__widget_inspector._Location))})))});
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/layout_grid.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;IAuByB;;;;;;IAAS;;;;;;IAEH;;;;;;IAEJ;;;;;;IAEZ;;;;;;IAAU;;;;;;IAEhB;;;;;;IAAgB;;;;;;IAEI;;;;;;;AAMO;IAAkB;;;QA5BnC;QACA;QACA;QACV;QACA;QACA;QACA;QACA;QACA;QACD;;IAeiB;IAEV;IA1BI;IACA;IACA;IACV;IACA;IACA;IACA;IACA;IACA;AAEH,2EAAW,GAAG;;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA6BX;AAEN,UAAG,AAAO,wBAAY;QACpB,AAAO,6BAAiB,AAAO;;AAGjC,UAAI,AAAO,yBAAa;QACtB,AAAO,8BAAkB,AAAO;;AAGlC,UAAI,AAAO,AAAmB,mCAAG,MAAM,AAAO,kCAAsC,iFAA4B,AAAO,mBAAO,AAAO;MACrI,iBAAW,AAAO;IACpB;UAG0B;MAExB,AAAO,iCAA2B,2DAAa,AAAO,qBAAS,A