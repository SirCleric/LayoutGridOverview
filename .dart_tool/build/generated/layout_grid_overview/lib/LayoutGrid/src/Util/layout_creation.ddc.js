define(['dart_sdk', 'packages/flutter_web/src/animation/animation', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_private_units'], function(dart_sdk, animation, layout_grid_units, layout_grid_private_units) {
  ...
  LayoutGrid__src__Util__layout_creation.Layout = class Layout extends core.Object {
    static createLayout(cols, rows, width, height) {
      ...
      LayoutGrid__src__Util__layout_creation.Layout._widthSizes = LayoutGrid__src__Util__layout_creation.Layout._initSizesListWithDefaultValue(dart.notNull(cols[$length]) + dart.notNull(rows[$length]));
      LayoutGrid__src__Util__layout_creation.Layout._heightSizes = LayoutGrid__src__Util__layout_creation.Layout._initSizesListWithDefaultValue(dart.notNull(cols[$length]) + dart.notNull(rows[$length]));
      ...
      for (let _i = 0; _i < dart.notNull(_joinedList[$length]); _i = _i + 1) {
        if (dart.equals(_joinedList[$_get](_i).axis, src__painting__basic_types.Axis.vertical) && LayoutGrid__src__Util__layout_creation.Layout._widthSizes[$_get](_joinedList[$_get](_i).index) === -1.0 || dart.equals(_joinedList[$_get](_i).axis, src__painting__basic_types.Axis.horizontal) && LayoutGrid__src__Util__layout_creation.Layout._heightSizes[$_get](_joinedList[$_get](_i).index) === -1.0) {
          if (LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.is(_joinedList[$_get](_i)) || LayoutGrid__src__Util__layout_grid_units.LayoutFraction.is(_joinedList[$_get](_i))) {
            dart.equals(_joinedList[$_get](_i).axis, src__painting__basic_types.Axis.vertical) ? _freeWidth = LayoutGrid__src__Util__layout_creation.Layout._manageMinMaxAndFractionsAndGetFreeSpace(_joinedList, _i, LayoutGrid__src__Util__layout_creation.Layout._widthSizes, width, _freeWidth) : _freeHeight = LayoutGrid__src__Util__layout_creation.Layout._manageMinMaxAndFractionsAndGetFreeSpace(_joinedList, _i, LayoutGrid__src__Util__layout_creation.Layout._heightSizes, height, _freeHeight);
          } else {
            dart.equals(_joinedList[$_get](_i).axis, src__painting__basic_types.Axis.vertical) ? _freeWidth = LayoutGrid__src__Util__layout_creation.Layout._manageDeterminedUnit(_joinedList, _i, width, _freeWidth) : _freeHeight = LayoutGrid__src__Util__layout_creation.Layout._manageDeterminedUnit(_joinedList, _i, height, _freeHeight);
          }
        }
      }
      return LayoutGrid__src__Util__layout_creation.Layout._calculateFinalList(cols, LayoutGrid__src__Util__layout_creation.Layout._widthSizes, LayoutGrid__src__Util__layout_creation.Layout._heightSizes);
    }
      ...
      for (let _i = 0; _i < dart.notNull(_layoutMinMaxList[$length]); _i = _i + 1) {
        if (LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.is(_layoutMinMaxList[$_get](_i))) {
          if (LayoutGrid__src__Util__layout_grid_units.LayoutFraction.is(_layoutMinMaxList[$_get](_i).unit)) {
            ...
            let maxValue = LayoutGrid__src__Util__layout_creation.Layout._getDeterminedValue(_layoutMinMaxList[$_get](_i).maxUnit, space);
            let minValue = LayoutGrid__src__Util__layout_creation.Layout._getDeterminedValue(_layoutMinMaxList[$_get](_i).minUnit, space);
    ...
    static _manageDeterminedMinMaxAndGetFreeSpace(joinedList, joinedListIndex, sizes, space, freeSpace) {
      let _finalFreeSpace = freeSpace;
      let value = LayoutGrid__src__Util__layout_creation.Layout._getDeterminedValue(LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.as(joinedList[$_get](joinedListIndex)).unit, space);
      let minValue = LayoutGrid__src__Util__layout_creation.Layout._getDeterminedValue(LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.as(joinedList[$_get](joinedListIndex)).minUnit, space);
      let maxValue = LayoutGrid__src__Util__layout_creation.Layout._getDeterminedValue(LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.as(joinedList[$_get](joinedListIndex)).maxUnit, space);
      if (dart.notNull(value) > dart.notNull(maxValue) && maxValue !== -1.0) {
    ...
    static _manageDeterminedUnit(joinedList, joinedListIndex, space, freeSpace) {
      let t5, t4, t3, t5$, t4$, t3$;
      let _finalFreeSpace = freeSpace;
      let value = LayoutGrid__src__Util__layout_creation.Layout._getDeterminedValue(joinedList[$_get](joinedListIndex), space);
      dart.equals(joinedList[$_get](joinedListIndex).axis, src__painting__basic_types.Axis.vertical) ? (t3 = LayoutGrid__src__Util__layout_creation.Layout._widthSizes, t4 = joinedList[$_get](joinedListIndex).index, t5 = value, t3[$_set](t4, t5), t5) : (t3$ = LayoutGrid__src__Util__layout_creation.Layout._heightSizes, t4$ = joinedList[$_get](joinedListIndex).index, t5$ = value, t3$[$_set](t4$, t5$), t5$);
      _finalFreeSpace = dart.notNull(_finalFreeSpace) - dart.notNull(value);
      return _finalFreeSpace;
    }
    static _getDeterminedValue(unit, space) {
      let _value = 0.0;
      if (LayoutGrid__src__Util__layout_grid_units.LayoutPixel.is(unit)) {
        ...
        if (dart.equals(unit.lineAxis, src__painting__basic_types.Axis.vertical)) {
          _value = unit.getValue(LayoutGrid__src__Util__layout_creation.Layout._widthSizes);
        } else {
          _value = unit.getValue(LayoutGrid__src__Util__layout_creation.Layout._heightSizes);
        }
      } else if (unit == null) {
        _value = -1.0;
      }
  ...
  dart.defineLazy(LayoutGrid__src__Util__layout_creation.Layout, {
    /*LayoutGrid__src__Util__layout_creation.Layout._widthSizes*/get _widthSizes() {
      return null;
    },
    set _widthSizes(_) {},
    /*LayoutGrid__src__Util__layout_creation.Layout._heightSizes*/get _heightSizes() {
      return null;
    },
    set _heightSizes(_) {}
  });
