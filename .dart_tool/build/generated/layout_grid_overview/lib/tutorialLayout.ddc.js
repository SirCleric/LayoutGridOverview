define(['dart_sdk', 'packages/flutter_web/animation', 'packages/layout_grid_overview/LayoutGrid/src/layout_grid', 'packages/layout_grid_overview/LayoutGrid/src/Util/inherited_layout_model', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_private_units', 'packages/layout_grid_overview/LayoutGrid/src/layout_grid_couple', 'packages/layout_grid_overview/Texts/textWidgets'], function(dart_sdk, animation, layout_grid, inherited_layout_model, layout_grid_units, layout_grid_private_units, layout_grid_couple, textWidgets) {
  ...
  tutorialLayout.TutorialLayout = class TutorialLayout extends src__widgets__framework.StatelessWidget {
    build(context) {
      return new src__widgets__basic.Padding.new({padding: const$ || (const$ = dart.const(new src__painting__edge_insets.EdgeInsets.symmetric({horizontal: 50.0, vertical: 50.0}))), child: new src__widgets__layout_builder.LayoutBuilder.new({builder: dart.fn((context, constraints) => new LayoutGrid__src__layout_grid.LayoutGrid.new({width: constraints.maxWidth, height: constraints.maxHeight, layoutModel: LayoutGrid__src__Util__inherited_layout_model.InheritedLayoutModel.of(context), columns: JSArrayOfLayoutUnit().of([new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 0.0, priority: 0}), new LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.new({minUnit: new LayoutGrid__src__Util__layout_grid_units.LayoutFraction.new({fraction: 1}), maxUnit: new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 200.0}), priority: 1, subPriority: 1}), new LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.new({minUnit: new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 400.0}), maxUnit: new LayoutGrid__src__Util__layout_grid_units.LayoutFraction.new({fraction: 1}), priority: 1, subPriority: 1}), new LayoutGrid__src__Util__layout_grid_units.LayoutMinMax.new({minUnit: new LayoutGrid__src__Util__layout_grid_units.LayoutFraction.new({fraction: 1}), maxUnit: new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 200.0}), priority: 1, subPriority: 0})]), rows: JSArrayOfLayoutUnit().of([new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: 0.0, priority: 0}), new LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new({pixels: constraints.maxHeight, priority: 0})]), couples: JSArrayOfLayoutGridCouple().of([new LayoutGrid__src__layout_grid_couple.LayoutGridCouple.new({widget: new Texts__textWidgets.SecondText.new({$creationLocationd_0dea112b090073317d4: const$1 || (const$1 = dart.const(new src__widgets__widget_inspector._Location.new({line: 39, column: 25, file: "org-dartlang-app:///packages/layout_grid_overview/tutorialLayout.dart", parameterLocations: const$0 || (const$0 = dart.constList([], src__widgets__widget_inspector._Location))})))}), col0: 1, col1: 2, row0: 0, row1: 1, modelKey: "SecondText"})]), $creationLocationd_0dea112b090073317d4: const$9 || (const$9 = dart.const(new src__widgets__widget_inspector._Location.new({line: 20, column: 18, file: "org-dartlang-app:///packages/layout_grid_overview/tutorialLayout.dart", parameterLocations: const$8 || (const$8 = dart.constList([const$2 || (const$2 = dart.const(new src__widgets__widget_inspector._Location.new({line: 21, column: 13, name: "width"}))), const$3 || (const$3 = dart.const(new src__widgets__widget_inspector._Location.new({line: 22, column: 13, name: "height"}))), const$4 || (const$4 = dart.const(new src__widgets__widget_inspector._Location.new({line: 24, column: 13, name: "layoutModel"}))), const$5 || (const$5 = dart.const(new src__widgets__widget_inspector._Location.new({line: 26, column: 13, name: "columns"}))), const$6 || (const$6 = dart.const(new src__widgets__widget_inspector._Location.new({line: 32, column: 13, name: "rows"}))), const$7 || (const$7 = dart.const(new src__widgets__widget_inspector._Location.new({line: 37, column: 13, name: "couples"})))], src__widgets__widget_inspector._Location))})))}), BuildContextAndBoxConstraintsToLayoutGrid()), $creationLocationd_0dea112b090073317d4: const$12 || (const$12 = dart.const(new src__widgets__widget_inspector._Location.new({line: 17, column: 14, file: "org-dartlang-app:///packages/layout_grid_overview/tutorialLayout.dart", parameterLocations: const$11 || (const$11 = dart.constList([const$10 || (const$10 = dart.const(new src__widgets__widget_inspector._Location.new({line: 18, column: 9, name: "builder"})))], src__widgets__widget_inspector._Location))})))}), $creationLocationd_0dea112b090073317d4: const$16 || (const$16 = dart.const(new src__widgets__widget_inspector._Location.new({line: 14, column: 12, file: "org-dartlang-app:///packages/layout_grid_overview/tutorialLayout.dart", parameterLocations: const$15 || (const$15 = dart.constList([const$13 || (const$13 = dart.const(new src__widgets__widget_inspector._Location.new({line: 15, column: 7, name: "padding"}))), const$14 || (const$14 = dart.const(new src__widgets__widget_inspector._Location.new({line: 17, column: 7, name: "child"})))], src__widgets__widget_inspector._Location))})))});
    }
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["org-dartlang-app:///packages/layout_grid_overview/tutorialLayout.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UAY4B;AACxB,YAAO,+CACU,gGAAiC,gBAAa,iBAEtD,6DACI,SAAc,SAAwB,gBAEtC,wDACE,AAAY,WAAD,mBACV,AAAY,WAAD,yBAEe,sEAAG,OAAO,YAEnC,0BACP,sEAAoB,eAAe,KACnC,wEAAsB,2EAAyB,cAAa,sEAAoB,mBAAgB,gBAAgB,KAChH,wEAAsB,sEAAoB,kBAAe,2EAAyB,eAAc,gBAAe,KAC/G,wEAAsB,2EAAyB,cAAa,sEAAoB,mBAAgB,gBAAe,aAE3G,0BACJ,sEAAoB,eAAe,KACnC,sEAAoB,AAAY,WAAD,sBAAsB,gBAG9C,gCACP,sEACU,4XAAoB,SAAS,SAAS,SAAS,aACrC;IAOhC;;;QAtCM;;AACD,iEAAW,GAAG;;EAAC","file":"tutorialLayout.ddc.js"}');
  // Exports:
  return {
