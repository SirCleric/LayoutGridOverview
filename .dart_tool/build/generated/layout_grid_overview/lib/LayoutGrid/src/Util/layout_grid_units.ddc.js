define(['dart_sdk', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_private_units'], function(dart_sdk, layout_grid_private_units) {
  ...
  (LayoutGrid__src__Util__layout_grid_units.LayoutPixel.new = function(opts) {
    ...
    this[pixels$] = pixels;
    if (!(pixels != null)) dart.assertFailed(null, "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units.dart", 8, 5, "pixels != null");
  ...
  (LayoutGrid__src__Util__layout_grid_units.LayoutPercentage.new = function(opts) {
    ...
    if (!(dart.notNull(percentage) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units.dart", 23, 5, "percentage >= 0.0");
  ...
  (LayoutGrid__src__Util__layout_grid_units.LayoutFraction.new = function(opts) {
    ...
    if (!(fraction != null)) dart.assertFailed(null, "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units.dart", 38, 5, "fraction != null");
  ...
  (LayoutGrid__src__Util__layout_grid_units.LayoutDependent.new = function(opts) {
    ...
    if (!(line != null)) dart.assertFailed(multiplicator != null, "org-dartlang-app:///packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units.dart", 69, 5, "line != null");
