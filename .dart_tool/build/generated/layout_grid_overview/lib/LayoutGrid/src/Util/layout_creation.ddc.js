define(['dart_sdk', 'packages/flutter_web/src/animation/animation', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_units', 'packages/layout_grid_overview/LayoutGrid/src/Util/layout_grid_private_units'], function(dart_sdk, animation, layout_grid_units, layout_grid_private_units) {
  ...
  LayoutGrid__src__Util__layout_creation.Layout = class Layout extends core.Object {
    static createLayout(cols, rows, width, height) {
      ...
      return LayoutGrid__src__Util__layout_creation.Layout._calculateFinalList(cols, rows, _widthSizes, _heightSizes);
    }
    ...
    static _calculateFinalList(cols, rows, widthSizes, heightSizes) {
      let t5, t4, t3, t5$, t4$, t3$, t6, t5$0, t4$0, t6$, t5$1, t4$1;
      ...
      for (let _i = 0; _i < dart.notNull(_finalList[$length]); _i = _i + 1) {
        if (_i < dart.notNull(colsLenght)) {
          try {
            cols[$_get](_i).referenceLine === -1 ? (t3 = _finalList, t4 = _i, t5 = widthPosition + dart.notNull(widthSizes[$_get](_i)), t3[$_set](t4, t5), t5) : (t3$ = _finalList, t4$ = _i, t5$ = dart.notNull(_finalList[$_get](cols[$_get](_i).referenceLine)) + dart.notNull(widthSizes[$_get](_i)), t3$[$_set](t4$, t5$), t5$);
            cols[$_get](_i).referenceLine === -1 ? widthPosition = widthPosition + dart.notNull(widthSizes[$_get](_i)) : widthPosition = widthPosition + (dart.notNull(_finalList[$_get](_i)) - dart.notNull(_finalList[$_get](_i - 1)));
          } catch (e$) {
          ...
          try {
            rows[$_get](_i - dart.notNull(colsLenght)).referenceLine === -1 ? (t4$0 = _finalList, t5$0 = _i, t6 = heightPosition + dart.notNull(heightSizes[$_get](_i - dart.notNull(colsLenght))), t4$0[$_set](t5$0, t6), t6) : (t4$1 = _finalList, t5$1 = _i, t6$ = dart.notNull(_finalList[$_get](dart.notNull(rows[$_get](_i - dart.notNull(colsLenght)).referenceLine) + dart.notNull(colsLenght))) + dart.notNull(heightSizes[$_get](_i - dart.notNull(colsLenght))), t4$1[$_set](t5$1, t6$), t6$);
            rows[$_get](_i - dart.notNull(colsLenght)).referenceLine === -1 ? heightPosition = heightPosition + dart.notNull(heightSizes[$_get](_i - dart.notNull(colsLenght))) : heightPosition = heightPosition + (dart.notNull(_finalList[$_get](_i)) - dart.notNull(_finalList[$_get](_i - 1)));
          } catch (e$0) {
